...
public class ChainConverterProviderTest {
    ...
    public void checkSingleProviderChain() {
        ...
        Queue providerQueue = chain.chainedProviders();
        assertThat(providerQueue.size()).isEqualTo(1);
        assertThat(providerQueue.poll()).isEqualTo(mockConverterProvider1);
    }
    ...
    public void checkMultipleProviderChain() {
        ...
        assertThat(providerQueue.poll()).isEqualTo(mockConverterProvider1);
        assertThat(providerQueue.poll()).isEqualTo(mockConverterProvider2);
    }
